...
def generate_tiling_for_data_loader(image_path, w_size):
...
def main():
    ...
    generate_tiling_for_data_loader(args.input_path, args.gt_path, args.save_image_path, args.save_gt_path, args.width)
